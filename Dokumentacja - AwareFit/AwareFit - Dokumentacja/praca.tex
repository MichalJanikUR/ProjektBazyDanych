...
\author{Oliwier Hędrzak, Michał Janik}
\shortauthor{O. Hędrzak, M. Janik}
\noAlbum{134913, 134915}

\titlePL{Dziennik treningowy AwareFit – dokumentacja projektowa}
\titleEN{AwareFit training log – project documentation}

\shorttitlePL{Dziennik treningowy AwareFit – dokumentacja projektowa} % skrócona wersja tytułu jeśli jest bardzo długi
\shorttitleEN{AwareFit training log – project documentation}

\thesistype{Praca projektowa}


\thesisDone{Praca wykonana pod kierunkiem}
\supervisor{dr inż. Piotr Grochowalski}
