...
<script>
    // Przekazujemy ID użytkownika do JavaScriptu w bezpieczny sposób
        ...
        <div class="workout-main-wrapper">
            ...
            <div id="step-muscle-groups" class="workout-step" style="display:none;">
                ...
                <div class="muscle-grid">
                    <?php
                    try {
                        // Pobranie parti mięśniowych przy użyciu funkcji słownikowej
                    ...
                    ?>
                        <div class="muscle-card" onclick="selectMuscleGroup('<?php echo htmlspecialchars($mg['name']); ?>')">
                            <div class="muscle-image-container">
                                <img src="<?php echo $imagePath; ?>" class="muscle-icon-img" alt="<?php echo htmlspecialchars($mg['name']); ?>">
                            </div>
                    ...
                    <?php 
                        ...
                        echo "<p>Błąd ładowania partii.</p>";
                    }
                    ?>
                </div>
            </div>
            ...
            <div id="step-log-set" class="workout-step" style="display:none;">
                ...
                <div id="current-exercise-sets" style="margin-top: 25px; width: 100%;"></div>
            </div>
