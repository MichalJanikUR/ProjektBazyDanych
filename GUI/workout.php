...
<head>
    ...
    <style>
    /* 1. GŁÓWNY PRZYCISK Z GRADIENTEM (Zakończ Trening) */
    .btn-finish {
        width: 100% !important;
        ...
        box-shadow: 0 4px 15px rgba(87, 202, 34, 0.3) !important;
    ...
    /* 2. ALTERNATYWNY GRADIENT (Zakończ Ćwiczenie - Ciemny/Szary) */
    .btn-finish-alt {
        background: var(--accent-gradient) !important;
        box-shadow: 0 4px 10px rgba(0, 0, 0, 0.3) !important;
    }

    /* 3. PRZYCISK PODSTAWOWY (Dodaj Serię / Dodaj Ćwiczenie) */
    .btn-basic {
        width: 100% !important;
        padding: 16px !important;
    ...
    .btn-basic:hover {
        ...
        border-color: #57ca22 !important;
    }

    /* Ikona w przycisku podstawowym ma kolor akcentu */
    .btn-basic i {
